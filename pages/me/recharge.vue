	...
	<view class="container">
		<u-navbar :title="i18n.recharge.title">
			<view class="slot-wrap">
				<view class="nav-btn" @click="openPage('list')"></view>
			</view>
		</u-navbar>
		<view class="coin-wrapper">
			<view class="coin-item" @click="handleChange(index, item)" :class="{ active: itemIndex == index }"
				v-for="(item, index) in rechargeInfo.coin_types" :key="index">
				<u-image :fade="false" :show-loading="false" class="coin-img" :src="item.icon" width="34rpx"
					height="34rpx" />
		...
		<view class="title-wrapper">
			...
			<u-image :fade="false" class="title-bg" :show-loading="false" src="/static/images/me/title_bg.png"
				width="74rpx" height="12rpx" />
		</view>
		...
		<view class="money-wrapper">
			<input type="number" v-model="amount" class="money-input"
				placeholder-style="color: #B6B6B6;font-size: 26rpx;" :placeholder="i18n.recharge.placeholder" />
		</view>
		...
		<view class="kf-icon">
			<u-image :fade="false" :show-loading="false" @click="openPage('kf')" src="/static/images/home/kf.png"
				width="127rpx" height="127rpx" />
		</view>
			...
			<view class="coupon-wrapper">
				...
				<view class="coupon-txt-wrapper">
					...
					<view class="coupon-txt">
						...
						<text class="get-amount" style="color:#FF2929">{{ target_amount }}$<text
								v-if="appData.currency && appData.currency.currency !=='USD'"
								style="font-size: 24rpx;">≈{{appData.currency.currency}}-{{appData.currency.symbol}}{{(Number(target_amount) * Number(appData.currency.rate)).toFixed(2)}}</text></text>
					</view>
				</view>
