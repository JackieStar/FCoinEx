<template>
	<view class="container">
		...
		<view class="bobao-wrapper">
			<view class="bobao-bg">
				<u-notice-bar mode="vertical" color='#fff' :volume-icon="false" type="none" class="notice-bar"
					:list="bobaoList" />
			</view>
		</view>
		<!-- 客服 -->
		<view class="kf-icon">
			<u-image @click="openPage('kf')" src="../../static/images/home/kf.png" width="127rpx" height="127rpx" />
		</view>
		<!-- 签到 -->
			...
			<view class="coupon-wrapper">
				...
				<view class="coupon-bg">
					...
					<view class="coupon-btn" @click="handlePostSign">
						{{ signData.today_signed == 1 ? i18n.home.signSuccess : i18n.home.fastSign }}</view>
