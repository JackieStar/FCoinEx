	...
	<view class="container">
		...
		<view class="coin-section m-t">
			...
			<view class="s-row little-line" @click="navToTrade(item)" v-for="(item, i) in markets" :key="item.symbol">
				...
				<view class="col r">
					<uni-tag size="large" type="success" v-if="item.diff_rate >= 0" :text="`+${item.diff_rate}%`"></uni-tag>
					<uni-tag size="large" type="error" v-else :text="`${item.diff_rate}%`"></uni-tag>
				</view>
			</view>
		</view>
		<!-- 平仓播报 -->
		...
		<!-- 客服 -->
		<view class="kf-icon">
			<u-image style="flex-shrink: 0;" :show-loading="false" :fade="false" @click="openPage('kf')" src="/static/images/home/kf.png" width="127rpx" height="127rpx" />
		</view>
		<!-- 签到 -->
			...
			<view class="coupon-wrapper">
				...
				<view class="coupon-bg">
					...
					<view class="coupon-tips">
						<view class="bottom-text">{{ i18n.home.signTips }}</view>
					</view>
				</view>
